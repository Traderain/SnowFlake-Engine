...
namespace WanderEngine
{
    ...
    public class TColor
    {
        ...
        public TColor(System.Drawing.Color pColor)
        {
            this.R = pColor.R / 255;
            this.G = pColor.G / 255;
            this.B = pColor.B / 255;
        ...
        /// <summary>
        /// Initialises a new instancia of the ColorValue struct.
        /// </summary>
        ...
        /// <summary>
        /// Returns a ColorValue that is interpolated between two ColorValues by the given amound (0.0-1.0).
        /// </summary>
