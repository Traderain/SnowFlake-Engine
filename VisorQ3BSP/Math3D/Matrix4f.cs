...
namespace Math3D
{
    ...
    public class Matrix4f
    {
        ...
        {
            this.GetTranslation(ref tempV3);
        ...
        /// <summary>
        /// Multiplica esta matriz (this) por la pasada como parámetro (mat4), el parámetro matriz (mat4result) es el resultado.
        ...
        public virtual void MultipliesBy(Matrix4f mat4, ref Matrix4f mat4result)
        {
            ...
            mat4result.values[00] = values[00] * mat4.values[00] + values[04] * mat4.values[01] + values[08] * mat4.values[02] + values[12] * mat4.values[03];
            mat4result.values[01] = values[01] * mat4.values[00] + values[05] * mat4.values[01] + values[09] * mat4.values[02] + values[13] * mat4.values[03];
            mat4result.values[02] = values[02] * mat4.values[00] + values[06] * mat4.values[01] + values[10] * mat4.values[02] + values[14] * mat4.values[03];
            mat4result.values[03] = values[03] * mat4.values[00] + values[07] * mat4.values[01] + values[11] * mat4.values[02] + values[15] * mat4.values[03];

            mat4result.values[04] = values[00] * mat4.values[04] + values[04] * mat4.values[05] + values[08] * mat4.values[06] + values[12] * mat4.values[07];
            mat4result.values[05] = values[01] * mat4.values[04] + values[05] * mat4.values[05] + values[09] * mat4.values[06] + values[13] * mat4.values[07];
            mat4result.values[06] = values[02] * mat4.values[04] + values[06] * mat4.values[05] + values[10] * mat4.values[06] + values[14] * mat4.values[07];
            mat4result.values[07] = values[03] * mat4.values[04] + values[07] * mat4.values[05] + values[11] * mat4.values[06] + values[15] * mat4.values[07];

            mat4result.values[08] = values[00] * mat4.values[08] + values[04] * mat4.values[09] + values[08] * mat4.values[10] + values[12] * mat4.values[11];
            mat4result.values[09] = values[01] * mat4.values[08] + values[05] * mat4.values[09] + values[09] * mat4.values[10] + values[13] * mat4.values[11];
            mat4result.values[10] = values[02] * mat4.values[08] + values[06] * mat4.values[09] + values[10] * mat4.values[10] + values[14] * mat4.values[11];
            mat4result.values[11] = values[03] * mat4.values[08] + values[07] * mat4.values[09] + values[11] * mat4.values[10] + values[15] * mat4.values[11];

            mat4result.values[12] = values[00] * mat4.values[12] + values[04] * mat4.values[13] + values[08] * mat4.values[14] + values[12] * mat4.values[15];
            mat4result.values[13] = values[01] * mat4.values[12] + values[05] * mat4.values[13] + values[09] * mat4.values[14] + values[13] * mat4.values[15];
            mat4result.values[14] = values[02] * mat4.values[12] + values[06] * mat4.values[13] + values[10] * mat4.values[14] + values[14] * mat4.values[15];
            mat4result.values[15] = values[03] * mat4.values[12] + values[07] * mat4.values[13] + values[11] * mat4.values[14] + values[15] * mat4.values[15];
        }
        /// <summary>
        ...
        {
            values[00] = mat.values[00]; values[04] = mat.values[04]; values[08] = mat.values[08]; values[12] = mat.values[12];
            values[01] = mat.values[01]; values[05] = mat.values[05]; values[09] = mat.values[09]; values[13] = mat.values[13];
            values[02] = mat.values[02]; values[06] = mat.values[06]; values[10] = mat.values[10]; values[14] = mat.values[14];
            values[03] = mat.values[03]; values[07] = mat.values[07]; values[11] = mat.values[11]; values[15] = mat.values[15];
        }
        /// <summary>
        /// pV = this * pV
        /// </summary>
